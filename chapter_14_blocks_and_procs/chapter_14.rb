...
puts do_until_false([5], build_array_of_squares).inspect # => [25, 16, 9, 4, 1, 0]
puts do_until_false(yum, always_false) # => lemonade with a hint of orange blossom water
puts
...
# 14.3 Pasing Blocks (Not Procs) into Methods
class Array
...
# Profile amount of time it takes to run some code
